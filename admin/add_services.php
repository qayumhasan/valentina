...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                    <h1 class="page-header">Add Valintien Offers & services</h1>
            </div>
                <!-- /.col-lg-12 -->
        </div>
        		  ...
        		  <?php 
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if ($title==''||$history==''||$status==''||$file_name=='') {
                          ...
                          $upload_path ="uploads/services/".$create_name;
                          move_uploaded_file($file_temp, $upload_path);
                          $query = "INSERT INTO tbl_services(title,body,images,status) VALUES ('$title','$history','$upload_path','$status')";
