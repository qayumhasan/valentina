    ...
    <div class="container-fluid">
        ...
        <?php 
          if (isset($_GET['del_id'])){ 
            ...
            $img_query = "SELECT * FROM tbl_testimonials WHERE id='$del_id'";
           ...
           if ($img_result) {
            ...
            $query = "DELETE FROM tbl_testimonials WHERE id='$del_id'";
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="update_testimonial.php?edit_id=<?php echo $row['id']; ?>">Edit</a> ||
