...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                    <h1 class="page-header">Manage Valintien History</h1>
            </div>
                <!-- /.col-lg-12 -->
        </div>
        ...
        <?php 
          if (isset($_GET['del_id'])){ 
            ...
            $del_edit=$_GET['del_id'];

            $img_query = "SELECT * FROM tbl_history WHERE id='$del_edit'";
           ...
           if ($img_result) {
            ...
            $query = "DELETE FROM tbl_history WHERE id='$del_edit'";
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="update_history.php?edit_id=<?php echo $row['id']; ?>">Edit</a> ||
