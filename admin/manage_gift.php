...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                    <h1 class="page-header">Manage Valintien Gift & Proposal</h1>
            </div>
                <!-- /.col-lg-12 -->
        </div>
        ...
        <?php 
          if (isset($_GET['del_id'])){ 
            ...
            $img_query = "SELECT * FROM tbl_gift WHERE id='$del_id'";
           ...
           if ($img_result) {
            ...
            $query = "DELETE FROM tbl_gift WHERE id='$del_id'";
            ...
            <table class="table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="update_gift.php?edit_id=<?php echo $row['id']; ?>">Edit</a> ||
