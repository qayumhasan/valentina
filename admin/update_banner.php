...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                    <h1 class="page-header">Update Valintien Banner</h1>
            </div>
                <!-- /.col-lg-12 -->
        </div>
      <?php
      ...
      $query = "SELECT * FROM tbl_banner WHERE id='$upid'";
       ...
       ?>          
        ...
        <div class="row">
        		  ...
        		  <?php 
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        if ($title==''||$history==''||$status==''||$file_name=='') {
                          ...
                          $upload_path ="uploads/banner/".$create_name;
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="stitle" value="<?php echo $row['stitle'];?>">
				  ...
				  <div class="form-group">
				    ...
				    <textarea class="form-control" rows="5" name="banner_dis"><?php echo $row['body'];?></textarea>
				  </div>
